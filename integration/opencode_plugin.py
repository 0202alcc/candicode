    ...
    mapping.update(
        {
            ...
            "requirements_gate": "requirements_gate(local)",
            "ci_gate": "ci_gate(local)",
            "security_gate": "security_gate(local)",
            "qa_perf_gate": "qa_perf_gate(local)",
            "reviewer_gate": "reviewer_gate(local)",
            "waiver_gate": "waiver_gate(local)",
            "release_rollout": "release_rollout(local)",
            "deploy_runner": "deploy_runner(local)",
            "health_gate": "health_gate(local)",
            "platform_health_gate": "platform_health_gate(local)",
            "dr_gate": "dr_gate(local)",
            "access_gate": "access_gate(local)",
...
def _phase_color_map() -> Dict[str, str]:
    return {
        ...
        "router_gate": "#EA580C",
        "requirements": "#FF8C00",
        "requirements_gate": "#F59E0B",
        "ci_gate": "#14B8A6",
        "security_gate": "#10B981",
        "qa_perf_gate": "#059669",
        "reviewer_gate": "#0EA5E9",
        "waiver_gate": "#0284C7",
        "release_rollout": "#2563EB",
        "deploy_runner": "#1D4ED8",
        "health_gate": "#0F766E",
        "platform_health_gate": "#0D9488",
        "dr_gate": "#0F766E",
        "access_gate": "#115E59",
        "versioning": "#FFD60A",
        "plan": "#A3E635",
